                                ...
                                <ul class="timeline">
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted" href="#">
                                            ...
                                            <h6 class="mb-0">یوتیوب ، یک وب سایت اشتراک ویدیو <strong
                                                    class="text-primary">50000 تومان</strong>.</h6>
                                        </a>
                                    </li>
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted" href="#">
                                            ...
                                            <h6 class="mb-0">سفارش جدید انجام شد <strong
                                    ...
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted" href="#">
                                            ...
                                            <h6 class="mb-0">جان فقط کالای خود را بخر <strong class="text-warning">250000
                                                    تومان</strong></h6>
                                        </a>
                                    </li>
                                    <li>
                                        ...
                                        <a class="timeline-panel text-muted" href="#">
                                            ...
                                            <h6 class="mb-0">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و
                                                با استفاده از طراحان گرافیک است. . </h6>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <table class="table table-responsive-sm mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="recent-stats d-flex align-items-center"><i
                                                class="fa fa-circle text-success mr-1"></i>موفقیت
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>آبان 1399</td>
                                        <td class="recent-stats d-flex align-items-center"><i
                                                class="fa fa-circle text-danger mr-1"></i>لغو شده
                                        </td>
                                        <td>
                                            <a href="#" class="btn btn-primary shadow btn-xs sharp mr-1"><i
                                                    class="fa fa-pencil"></i></a>
                                    ...
                                    <tr>
                                        ...
                                        <td>آبان 1399</td>
                                        <td class="recent-stats d-flex align-items-center"><i
                                                class="fa fa-circle text-warning mr-1"></i>در انتظار
                                        </td>
                                        <td>
                                            <a href="#" class="btn btn-primary shadow btn-xs sharp mr-1"><i
                                                    class="fa fa-pencil"></i></a>
        ...
        <div class="col-xl-3 col-xxl-4 col-lg-12 col-md-12">
            <div class="card overflow-hidden">
                <div class="card-header pb-0 border-0">
                    <h4 class="card-title">محصولات پرفروش</h4>
                </div>
                <div class="card-body">
                        ...
                        <ul class="timeline">
                            <li>
                                <div class="timeline-panel">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mb-1">دکتر سلطان ها برای شما می فرستند</h5>
                            ...
                            <li>
                                <div class="timeline-panel">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mb-1">گزارش ایجاد شد</h5>
                                        <small class="d-block">آبان 1399 - 13:45 بعد ظهر</small>
                                    </div>
                                    <div class="dropdown">
                            ...
                            <li>
                                <div class="timeline-panel">
                                    ...
                                    <div class="media-body">
                                        <h5 class="mb-1">یادآوری: درمان</h5>
                                        <small class="d-block">آبان 1399 - 13:45 بعد ظهر</small>
                                    </div>
                                    <div class="dropdown">
            ...
            <div id="user-activity" class="card">
                <div class="card-header border-0 pb-0 d-sm-flex d-block">
                    <div>
                        ...
                        <p class="mb-1">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان
                            گرافیک است. </p>
                    </div>
